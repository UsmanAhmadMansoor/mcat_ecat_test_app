...
public class TestAcitivityBackUpCode extends AppCompatActivity implements View.OnClickListener{
    ...
    int buttonFlag = 0,alreadySelected=-1,optionSelected;
    ...
    int mcqPointer,optionPointer = 0 , skipPointer;
    ...
    myDBAdapter helper,optionHelper,correctHelper;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        LoadMCQS("http://192.168.18.199/mCAT_ECAT_TestPreparation/loadMCQS.php");
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //onPause();
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(TestAcitivityBackUpCode.this);
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface arg0, int arg1) {
                                ...
                                helper.saveTimer(String.valueOf(TimeLeft),String.valueOf(mcqPointer-1),String.valueOf(paperId),
                                        ...
                                        String.valueOf(skipPointer),String.valueOf(skipPointer));
                                for(int i=0;i<skippedMCQs.size();i++ ){
                                    helper2.saveID(String.valueOf(i),String.valueOf(skippedMCQs.get(i).mcq_id));
                                }

                                //Toast.makeText(TestAcitivityBackUpCode.this,String.valueOf(TimeLeft),Toast.LENGTH_LONG).show();
                                //Intent it = new Intent(TestAcitivityBackUpCode.this,MainActivity.class);
                                //startActivity(it);
...
//
    ...
    private void showNextMCQ(){
        ...
        {
            Toast.makeText(TestAcitivityBackUpCode.this,"Please Tap Your Option", Toast.LENGTH_LONG).show();
            for (int i = 0; i < optButton.length; i++) {
        ...
        else
        {
            ...
            //LoadCorrectAnswer("http://192.168.18.199/mCAT_ECAT_TestPreparation/loadCorrectAnswer.php",current.mcq_id);
            ...
            handler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    if(mcqPointer < list.size()){
                        ...
                        //LoadMCQOptions("http://192.168.18.199/mCAT_ECAT_TestPreparation/loadMCQOptions.php",current.mcq_id);
                        //LoadMCQOptions("http://192.168.18.199/mCAT_ECAT_TestPreparation/loadMCQOptions.php");
                        ...
                        if(!skippedAttempt){
                            ...
                            alertDialogBuilder.setPositiveButton("Yes",
                                    new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface arg0, int arg1) {
                                            LoadSkippedMCQS("http://192.168.18.199/mCAT_ECAT_TestPreparation/loadSkippedMCQ.php",skippedMCQs.get(skipPointer).mcq_id);
                                            //skipPointer++;
                            ...
                            alertDialogBuilder.setNegativeButton("No", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    dialogInterface.dismiss();
                                    countDownTimer.cancel();
                                    Intent it = new Intent(TestAcitivityBackUpCode.this,TestScoreActivity.class);
    ...
    private void LoadMCQS(String url){
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(TestAcitivityBackUpCode.this);
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        list2.add(listData);
                        //optionHelper.saveMCQoptions("0",id,option);
                    ...
                    for (int i = 0; i < optButton.length; i++) {
                        ...
                        optButton[i].setOnClickListener((View.OnClickListener) TestAcitivityBackUpCode.this);
                        optionPointer = optionPointer + 1 ;
                    }
                    //LoadCorrectAnswer("http://192.168.18.199/mCAT_ECAT_TestPreparation/loadCorrectAnswer.php",current.mcq_id);
                    LoadCorrectAnswer("http://192.168.18.199/mCAT_ECAT_TestPreparation/loadCorrectAnswer.php");
                    //current = list2.get(0);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    //LoadMCQOptions("http://192.168.18.199/mCAT_ECAT_TestPreparation/loadMCQOptions.php",mcq_id);
                    LoadMCQOptions("http://192.168.18.199/mCAT_ECAT_TestPreparation/loadMCQOptions.php");
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    private void LoadMCQOptionFromLocalDB(){
        ...
        for (int i = 0; i < 4; i++) {
            //String option = optionHelper.getMCQOption(String.valueOf(3),current.mcq_id);
            listData = new PaperData();
            //listData.option_name = option;
            list2.add(listData);
            //Log.d("TestOption",id + " " + option);
